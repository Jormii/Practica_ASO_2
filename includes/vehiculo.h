...
#define NUM_RETURNS 2          /* Numero de variables que se recibiran por parte del parking despues de enviar la operacion \
                               de aparque. */
#define RETURN_PISO 0          // Posicion que almacena el piso en el que se aparco el vehiculo.
...
/**
 * Funcion que implementa un bucle que envia mensajes de aparque y salida al parking.
 */
